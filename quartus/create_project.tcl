# =============================================================================
# create_project.tcl - builds the Quartus Prime Pro project for Cyclone 10 GX
# -----------------------------------------------------------------------------
# USAGE (from the quartus/ directory, with Quartus):
#     quartus_sh -t create_project.tcl
# Then either open int8_matmul.qpf in the GUI, or compile from the shell:
#     quartus_sh --flow compile int8_matmul
#
# VIRTUAL PINS:
#   matmul_top has around 770 logical I/O bits (wide matrix buses), far more than
#   any package exposes. We mark all data I/O as VIRTUAL so the Fitter treats
#   them as internal nets. 
#   Only clk is left as a real input.
# =============================================================================
...
project_new int8_matmul -overwrite
...
set_instance_assignment -name VIRTUAL_PIN ON -to sel_systolic
...
project_close
puts "Project int8_matmul created. Compile with: quartus_sh --flow compile int8_matmul"
